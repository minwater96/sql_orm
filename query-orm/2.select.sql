...
-- Movie.objects.all().order_by('year') :내림차순
-- SELECT * FROM movies_movie
-- ORDER BY year;

-- Movie.objects.all().order_by('-year') :오림차순
-- SELECT * FROM movies_movie
-- ORDER BY year DESC;

-- Movies.objects.filter(year=2000)
-- SELECT * 
-- FROM movies_movie
-- WHERE year=2000;
...
-- Movie.objects.aggreate(Max('year'))
...
-- Movie.objects.filter(title__startwith='the')
-- SELECT *
-- FROM movies_movie
-- WHERE title like 'the%';
